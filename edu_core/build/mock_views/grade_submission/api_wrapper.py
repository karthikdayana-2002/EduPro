...
def api_wrapper(*args, **kwargs):
    ...
    try:
        from edu_core.views.grade_submission.request_response_mocks \
    ...
    try:
        response = ''
        status_code = 200
        if '200' in ['200', '400', '403', '404', '500']:
            from edu_core.views.grade_submission.request_response_mocks \
                import RESPONSE_200_JSON
            response = RESPONSE_200_JSON
            status_code = 200
        elif '201' in ['200', '400', '403', '404', '500']:
            from edu_core.views.grade_submission.request_response_mocks \
    ...
    response_tuple = mock_response(
        ...
        operation_name="grade_submission",
